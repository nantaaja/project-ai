        ...
        <aside
            ...
            <div>
                <div class="px-8 pt-10 pb-8">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-14 h-14 rounded-2xl primary-gradient flex items-center justify-center shadow-lg shrink-0">
                ...
                <nav class="px-5 space-y-3 lg:space-y-3 grid grid-cols-2 gap-2 lg:block mb-6 lg:mb-0">
                    <a href="/productivity"
                        class="menu-active flex items-center gap-2 md:gap-4 px-4 py-3 md:px-5 md:py-4 rounded-2xl font-semibold text-sm md:text-base">
            ...
            <div class="hidden lg:block p-5">
                <div class="glass-card rounded-2xl p-4 flex items-center gap-4">
                    ...
                    <div>
                        <h4 class="font-semibold text-slate-700">Kelompok UTS</h4>
                        <p class="text-sm text-slate-500">Decision Tree & Clustering</p>
                    </div>
                </div>
            </div>
        ...
        <main class="flex-1 p-5 md:p-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <div class="flex items-center gap-8 self-start md:self-auto">
                    <div
                        class="flex items-center gap-3 text-slate-600 bg-white px-4 py-2 rounded-xl border border-slate-200">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                <div class="glass-card rounded-3xl p-5 md:p-7">
                    ...
                    @if (session('success'))
                        <div class="mb-6 bg-green-50 border border-green-200 rounded-2xl p-5">
                            <h4 class="font-bold text-green-700">Kalkulasi Berhasil!</h4>
                    ...
                    <form action="{{ route('productivity.calculate') }}" method="POST" class="space-y-5">
                        ...
                        <div class="flex flex-col md:grid md:grid-cols-[200px_1fr] gap-2 md:gap-4 md:items-center">
                            <div class="flex items-center gap-3 text-slate-700 font-medium">
                                <div
                                    class="w-10 h-10 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600 shrink-0">
                        ...
                        <div
                            class="flex flex-col md:grid md:grid-cols-[200px_1fr] gap-2 md:gap-4 md:items-center">
                            <div class="flex items-center gap-3 text-slate-700 font-medium">
                                <div
                                    class="w-10 h-10 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600 shrink-0">
                        ...
                        <div class="pt-5 md:pt-3">
                            <button type="submit"
                                class="w-full h-14 md:h-16 rounded-2xl primary-gradient text-white text-base md:text-lg font-semibold shadow-lg hover:scale-[1.01] transition">
                                <i class="fa-solid fa-magnifying-glass mr-2 md:mr-3"></i>
                                Analisis Sekarang
                            </button>
                        </div>
                    </form>
                ...
                <div class="glass-card rounded-3xl p-5 md:p-7">
                    ...
                    <div
                        class="mt-6 md:mt-8 soft-purple border border-purple-100 rounded-2xl p-4 md:p-5 flex items-start gap-4 md:gap-5">
                        <div class="text-purple-600 text-2xl md:text-3xl mt-1 shrink-0">
                        ...
                        <tbody>
                            @forelse($history as $index => $item)
                                <tr class="border-b border-slate-100 hover:bg-slate-50 transition">
                                    ...
                                    <td class="p-4 md:p-5">{{ $item->intensitas_device }}</td>
                                    <td class="p-4 md:p-5">{{ $item->tingkat_interaksi }}</td>
                                    <td class="p-4 md:p-5">{{ $item->tingkat_fokus }}</td>
                                    <td class="p-4 md:p-5">
                                        <span
                                            class="px-3 py-1 md:px-4 md:py-2 rounded-full text-xs md:text-sm font-semibold bg-green-100 text-green-700">
                                            {{ $item->label_hasil }}
                                        </span>
                                    </td>
                                </tr>
